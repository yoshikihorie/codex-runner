...
func TestNewCheckStallUseCaseIsUsableFromExternalPackage(t *testing.T) {
	...
	uc := usecase.NewCheckStallUseCase(&externalStore{}, mutex, liveness, &externalWriter{}, domain.ClockFunc(func() time.Time { return time.Time{} }), &metrics.StalledTimeTracker{}, ownership, externalOrphanCoordinator{}, slog.Default())
